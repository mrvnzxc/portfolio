  ...
  <section id="achievements" class="section-band-b">
    <div class="mx-auto max-w-6xl 2xl:max-w-7xl px-4">
      ...
      <div class="grid gap-8 lg:grid-cols-2">
        <div class="reveal-on-scroll achievement-card space-panel p-6 text-sm text-muted">
        ...
        <div class="reveal-on-scroll achievement-card space-panel p-6 text-sm text-muted">
          <h3 class="mb-4 text-lg font-semibold text-ink">Programming Competitions</h3>
          <div class="grid gap-3 sm:grid-cols-2">
            ...
            >
              <figure class="overflow-hidden rounded-[inherit]">
                ...
                >
                <figcaption class="px-3 py-2 font-mono text-[11px] text-muted">Contest moment {{ n }}</figcaption>
              </figure>
            </NeonBorderReveal>
          </div>
        </div>
